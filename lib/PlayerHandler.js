...
export default class PlayerHandler {
	 ...
	 * @param {import('discord.js').InteractionReplyOptions & import('discord.js').APIEmbed & {additionalEmbeds?: [EmbedBuilder]}} embedExtras Extra data to be passed to the embed.
