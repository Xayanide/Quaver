...
export default class PlayerHandler {
	 ...
	 * @param {string} key The key name of the locale string to be used.
	 * @param {import('discord.js').MessageOptions & import('discord.js').MessagePayload & import('discord.js').InteractionReplyOptions & import('discord.js').WebhookEditMessageOptions & {type?: "success"|"neutral"|"warning"|"error", vars: string[]}} optionals Extra data, such as type or components.
	 * @returns {Promise<import('discord.js').Message>|false} The message that was sent.
	 */
	async locale(key, { vars = [], type = 'neutral', components = null, files = null } = {}) {
		return this.send(await getGuildLocale(this.player.guildId, key, ...vars), { type, components, files });
	}
}
