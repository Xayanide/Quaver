...
export default class ReplyHandler {
	...
	/**
	 * @typedef {import('discord.js').InteractionReplyOptions & import('discord.js').APIEmbed & {additionalEmbeds?: EmbedBuilder}} embedExtrasOptions
	 */
	 ...
	 * @param {embedExtrasOptions} embedExtras Extra data to be passed to the embed.
	...
	replyDataConstructor(msg, embedExtras, type = 'neutral') {
		/** @type {import('discord.js').InteractionReplyOptions & import('discord.js').APIEmbed & {embeds?: [EmbedBuilder, embedExtrasOptions]}} */
		const replyData = {
			embeds: [
				new EmbedBuilder()
